    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px]">
        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <div className="mb-2 mt-2 text-xs border-t pt-3">

            <p>
              <strong>Payment Method:</strong>{" "}
              {orderInfo.payment?.method || "Cash"}
            </p>

            {orderInfo.payment?.method === "Online" && (
              <>
                <p>
                  <strong>Payment ID:</strong> {orderInfo.payment?.id}
                </p>

                <p>
                  <strong>Status:</strong> {orderInfo.payment?.status}
                </p>
              </>
            )}
